...
namespace OrzhansJozve.Web.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage ="لطفا ایمیل ادمین جدید را وارد کنید")]
            [EmailAddress(ErrorMessage ="لطفا ایمیل معتبر وارد کنید")]
            [Display(Name = "ایمیل")]
            public string Email { get; set; }

            [Required(ErrorMessage = "لطفا کلمه عبور ادمین جدید را وارد کنید")]
            ...
            [Compare("Password", ErrorMessage = "کلمه عبور جدید با کلمه عبور جدید تایید شده مطابقت ندارد")]
